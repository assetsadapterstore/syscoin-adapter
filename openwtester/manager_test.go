...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO SYS", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "WAKQCpVtzjbsY6dfNSHfPNfzhW1rLSG2RR")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	account := &openwallet.AssetsAccount{Alias: "mainnetSYS", WalletID: walletID, Required: 1, Symbol: "SYS", IsTrust: true}
